...
#define EVERY_X_MICROS(...) EVERY_X_MICROS_I(CONCAT_MACRO(EVERY_X_, __COUNTER__ ),__VA_ARGS__)
#define EVERY_X_MICROS_I(NAME,...) static CEveryXMicros NAME(__VA_ARGS__); if( NAME )
#define EVERY_X_MILLIS(...) EVERY_X_MILLIS_I(CONCAT_MACRO(EVERY_X_, __COUNTER__ ),__VA_ARGS__)
#define EVERY_X_MILLIS_I(NAME,...) static CEveryXMillis NAME(__VA_ARGS__); if( NAME )
#define EVERY_X_SECONDS(...) EVERY_X_SECONDS_I(CONCAT_MACRO(EVERY_X_, __COUNTER__ ),__VA_ARGS__)
#define EVERY_X_SECONDS_I(NAME,...) static CEveryXSeconds NAME(__VA_ARGS__); if( NAME )
#define EVERY_X_BSECONDS(...) EVERY_X_BSECONDS_I(CONCAT_MACRO(EVERY_X_, __COUNTER__ ),__VA_ARGS__)
#define EVERY_X_BSECONDS_I(NAME,...) static CEveryXBSeconds NAME(__VA_ARGS__); if( NAME )
#define EVERY_X_MINUTES(...) EVERY_X_MINUTES_I(CONCAT_MACRO(EVERY_X_, __COUNTER__ ),__VA_ARGS__)
#define EVERY_X_MINUTES_I(NAME,...) static CEveryXMinutes NAME(__VA_ARGS__); if( NAME )
#define EVERY_X_HOURS(...) EVERY_X_HOURS_I(CONCAT_MACRO(EVERY_X_, __COUNTER__ ),__VA_ARGS__)
#define EVERY_X_HOURS_I(NAME,...) static CEveryXHours NAME(__VA_ARGS__); if( NAME )
